...
- **Writer task:** Expand this file into one complete article answering: “Data, Privacy, dan Provider Risk untuk AI”
- **Reader and situation:** Team sending prompts, documents, or user data to a model/provider
- **Reader outcome:** Inventory data rights/sensitivity, minimization, provider terms, retention/training, location/transfers, access, logging, deletion, and alternative
- **Primary intent:** Evaluate data handling before using an AI service
...
- **Scope boundary:** Does not approve a provider or legal basis; CDV-09-A05 owns Indonesian privacy analysis and current provider terms govern
- **Final public route:** `/artikel/data-privacy-provider-risk-ai.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Data, Privacy, dan Provider Risk untuk AI**.
...
- **Tie back to this article:** Keep the explanation specific to “Data, Privacy, dan Provider Risk untuk AI”.
