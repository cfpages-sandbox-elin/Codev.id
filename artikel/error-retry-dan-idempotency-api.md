...
- **Writer task:** Expand this file into one complete article answering: “Error, Retry, dan Idempotency pada API”
- **Reader and situation:** Developer handling network or dependency failures
- **Reader outcome:** Design error semantics, correlation, retryability, timeout, backoff, idempotency keys, deduplication, and reconciliation tests
- **Primary intent:** Prevent duplicate effects and ambiguous recovery
...
- **Scope boundary:** Does not guarantee exactly-once delivery; CDV-08-A05 owns third-party recovery and CDV-12 owns incident telemetry
- **Final public route:** `/artikel/error-retry-dan-idempotency-api.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Error, Retry, dan Idempotency pada API**.
...
- **Tie back to this article:** Keep the explanation specific to “Error, Retry, dan Idempotency pada API”.
