...
- **Writer task:** Expand this file into one complete article answering: “Acceptance Test untuk Integrasi Eksternal”
- **Reader and situation:** Buyer accepting work involving an external system
- **Reader outcome:** Test credentials/roles, normal and duplicate events, invalid data, timeout, rate limits, replay, reconciliation, observability, and disconnect
- **Primary intent:** Verify an integration beyond the happy path
...
- **Scope boundary:** Does not replace provider certification or production monitoring; CDV-12 owns live health and CDV-10-A05 owns release acceptance
- **Final public route:** `/artikel/acceptance-test-integrasi-eksternal.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Acceptance Test untuk Integrasi Eksternal**.
...
- **Tie back to this article:** Keep the explanation specific to “Acceptance Test untuk Integrasi Eksternal”.
