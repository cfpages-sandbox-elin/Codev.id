...
description: "Define brief, sourcing, author, technical/legal review, edit, approval, publish, corrections, review date, retirement, and audit trail"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Editorial Workflow dari Draft sampai Update”
- **Reader and situation:** Organization using multiple authors, reviewers, or AI tools
- **Reader outcome:** Define brief, sourcing, author, technical/legal review, edit, approval, publish, corrections, review date, retirement, and audit trail
- **Primary intent:** Establish accountable creation, review, publication, and maintenance
...
- **Scope boundary:** Does not promise 24/7 writing or originality from a tool alone; `/konten/*` owns substantiated service terms
- **Final public route:** `/artikel/editorial-workflow-draft-update.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Editorial Workflow dari Draft sampai Update**.
...
- `CDV-19-A01` → `/artikel/content-model-dan-taxonomy.html` — Content Model dan Taxonomy yang Bisa Dirawat
...
- **Tie back to this article:** Keep the explanation specific to “Editorial Workflow dari Draft sampai Update”.
