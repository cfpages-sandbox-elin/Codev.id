...
- **Writer task:** Expand this file into one complete article answering: “Source Code, IP, Data, Akun, dan Lisensi dalam Kontrak”
- **Reader and situation:** Buyer wanting operational independence
- **Reader outcome:** Inventory background/new IP, source/repository, open-source/third-party licenses, data roles/exports, domains/cloud/app accounts, credentials, documentation, and exit rights
- **Primary intent:** Clarify ownership and use rights before work starts
...
- **Scope boundary:** General education only; it does not determine ownership under a specific contract. Qualified Indonesian legal review is required
- **Final public route:** `/artikel/source-code-ip-data-akun-lisensi-kontrak.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Source Code, IP, Data, Akun, dan Lisensi dalam Kontrak**.
...
- **Tie back to this article:** Keep the explanation specific to “Source Code, IP, Data, Akun, dan Lisensi dalam Kontrak”.
