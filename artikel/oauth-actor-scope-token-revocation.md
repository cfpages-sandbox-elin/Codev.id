...
description: "Identify actors, redirect flow, scopes, consent, token storage/rotation, refresh, revocation, errors, and account disconnect"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “OAuth Integration: Actor, Scope, Token, dan Revocation”
- **Reader and situation:** Team connecting to a service that uses OAuth
- **Reader outcome:** Identify actors, redirect flow, scopes, consent, token storage/rotation, refresh, revocation, errors, and account disconnect
- **Primary intent:** Model a delegated-authorization integration safely
...
- **Scope boundary:** Does not implement a provider flow from generic examples; current provider docs and CDV-09-A03 control the implementation
- **Final public route:** `/artikel/oauth-actor-scope-token-revocation.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **OAuth Integration: Actor, Scope, Token, dan Revocation**.
...
- **Tie back to this article:** Keep the explanation specific to “OAuth Integration: Actor, Scope, Token, dan Revocation”.
