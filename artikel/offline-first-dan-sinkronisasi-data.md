...
- **Writer task:** Expand this file into one complete article answering: “Offline-first dan Sinkronisasi Data Tanpa Duplikasi”
- **Reader and situation:** Product used in field, travel, or unstable networks
- **Reader outcome:** Define local state, sync triggers, identity, conflict policy, idempotency, user feedback, recovery, and tests
- **Primary intent:** Design app behavior under intermittent connectivity
...
- **Scope boundary:** Does not prescribe a database or conflict rule universally; CDV-07-A02 owns storage choice and CDV-06-A05 owns idempotency
- **Final public route:** `/artikel/offline-first-dan-sinkronisasi-data.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Offline-first dan Sinkronisasi Data Tanpa Duplikasi**.
...
- **Tie back to this article:** Keep the explanation specific to “Offline-first dan Sinkronisasi Data Tanpa Duplikasi”.
