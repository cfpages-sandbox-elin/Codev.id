...
description: "Choose wireframe, visual mockup, clickable prototype, or coded prototype by uncertainty, cost, and evidence goal"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Wireframe, Mockup, atau Prototype: Pilih Sesuai Risiko”
- **Reader and situation:** Buyer unsure what design artifact to request
- **Reader outcome:** Choose wireframe, visual mockup, clickable prototype, or coded prototype by uncertainty, cost, and evidence goal
- **Primary intent:** Select the right design fidelity for a decision
...
- **Scope boundary:** Does not treat a prototype as production software; CDV-04 owns web implementation and CDV-05 owns app implementation
- **Final public route:** `/artikel/wireframe-mockup-atau-prototype.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Wireframe, Mockup, atau Prototype: Pilih Sesuai Risiko**.
...
- `CDV-02-A01` → `/artikel/rencana-riset-pengguna-proporsional.html` — Rencana Riset Pengguna yang Proporsional
- `CDV-02-A02` → `/artikel/information-architecture-dan-user-flow.html` — Information Architecture dan User Flow yang Bisa Diuji
- `CDV-02-A04` → `/artikel/uji-kegunaan-tugas-observasi-temuan.html` — Uji Kegunaan: Tugas, Observasi, dan Temuan
...
- **Tie back to this article:** Keep the explanation specific to “Wireframe, Mockup, atau Prototype: Pilih Sesuai Risiko”.
