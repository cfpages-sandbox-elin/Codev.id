...
- **Writer task:** Expand this file into one complete article answering: “Technical SEO Audit dari Crawl sampai Canonical”
- **Reader and situation:** Site owner with indexing, rendering, or duplication concerns
- **Reader outcome:** Check response/indexability, rendering, internal links, canonicals, sitemap/robots, structured data, pagination, duplicates, logs/GSC, and prioritized evidence
- **Primary intent:** Diagnose discoverability and duplication technically
...
- **Scope boundary:** Does not guarantee indexing/ranking or prescribe backlink schemes; CDV-19-A05 owns migrations and commercial SEO stays on verified routes
- **Final public route:** `/artikel/technical-seo-audit-crawl-canonical.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Technical SEO Audit dari Crawl sampai Canonical**.
...
- **Tie back to this article:** Keep the explanation specific to “Technical SEO Audit dari Crawl sampai Canonical”.
