...
- **Writer task:** Expand this file into one complete article answering: “Migrasi Data dengan Rekonsiliasi dan Rollback”
- **Reader and situation:** Team replatforming, importing, or changing schema
- **Reader outcome:** Plan inventory, mapping, cleansing, dry runs, cutover, validation totals, exceptions, rollback, audit, and sign-off
- **Primary intent:** Move data without silently losing meaning or integrity
...
- **Scope boundary:** Does not merge content/URL migration; CDV-19-A05 owns web content migration and CDV-11-A04 owns deployment sequence
- **Final public route:** `/artikel/migrasi-data-rekonsiliasi-rollback.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Migrasi Data dengan Rekonsiliasi dan Rollback**.
...
- `CDV-07-A01` → `/artikel/data-model-dari-istilah-bisnis.html` — Data Model dari Istilah Bisnis ke Constraint
...
- **Tie back to this article:** Keep the explanation specific to “Migrasi Data dengan Rekonsiliasi dan Rollback”.
