...
description: "Capture reason, alternatives, benefit, impact on requirements/design/data/security/testing/time/cost, decision authority, baseline update, and communication"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Change Control yang Menjaga Nilai dan Baseline”
- **Reader and situation:** Client or vendor receiving a change request
- **Reader outcome:** Capture reason, alternatives, benefit, impact on requirements/design/data/security/testing/time/cost, decision authority, baseline update, and communication
- **Primary intent:** Evaluate and authorize scope/design changes transparently
...
- **Scope boundary:** Does not block urgent incident mitigation; CDV-12-A05 owns incidents and CDV-17-A05 owns commercial effect
- **Final public route:** `/artikel/change-control-nilai-baseline.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Change Control yang Menjaga Nilai dan Baseline**.
...
- `CDV-18-A01` → `/artikel/raci-proyek-digital.html` — RACI Proyek Digital: Keputusan, Pekerjaan, dan Konsultasi
...
- **Tie back to this article:** Keep the explanation specific to “Change Control yang Menjaga Nilai dan Baseline”.
