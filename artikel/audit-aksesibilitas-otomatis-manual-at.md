...
description: "Combine automated scans, code review, keyboard, zoom/reflow, contrast, screen-reader/AT, user tasks, severity, evidence, and retest"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Audit Aksesibilitas: Otomatis, Manual, dan Assistive Technology”
- **Reader and situation:** Team preparing release or remediation
- **Reader outcome:** Combine automated scans, code review, keyboard, zoom/reflow, contrast, screen-reader/AT, user tasks, severity, evidence, and retest
- **Primary intent:** Plan an accessibility evaluation with defensible evidence
...
- **Scope boundary:** Does not turn a scanner score into certification; CDV-13-A01 owns conformance scope and disabled users remain essential evidence
- **Final public route:** `/artikel/audit-aksesibilitas-otomatis-manual-at.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Audit Aksesibilitas: Otomatis, Manual, dan Assistive Technology**.
...
- **Tie back to this article:** Keep the explanation specific to “Audit Aksesibilitas: Otomatis, Manual, dan Assistive Technology”.
