...
- **Writer task:** Expand this file into one complete article answering: “Memilih Arketipe Website dari Tugas Pengguna”
- **Reader and situation:** Buyer facing the site's 28 industry service pages
- **Reader outcome:** Distinguish brochure, catalog, publication, lead generation, membership, marketplace, learning, donation, booking, and commerce by tasks/data/risks
- **Primary intent:** Group website needs by workflow instead of industry labels
...
- **Scope boundary:** Does not create industry- or city-swapped landing pages; existing `/website/*` routes need proof and consolidation review
- **Final public route:** `/artikel/memilih-arketipe-website-dari-tugas.html`
- **Appointed CMS date:** `2025-06-23` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Arketipe Website dari Tugas Pengguna**.
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Arketipe Website dari Tugas Pengguna”.
