...
description: "Map purpose, system copies, legal/business needs, schedules, holds, deletion/anonymization, vendor propagation, verification, and records"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Retention dan Penghapusan Data yang Bisa Dibuktikan”
- **Reader and situation:** Privacy, product, and operations teams reconciling obligations
- **Reader outcome:** Map purpose, system copies, legal/business needs, schedules, holds, deletion/anonymization, vendor propagation, verification, and records
- **Primary intent:** Define data retention and deletion across copies
...
- **Scope boundary:** Does not issue a legal retention period; CDV-09-A05 owns PDP analysis and qualified legal review is required
- **Final public route:** `/artikel/retention-dan-penghapusan-data.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Retention dan Penghapusan Data yang Bisa Dibuktikan**.
...
- **Tie back to this article:** Keep the explanation specific to “Retention dan Penghapusan Data yang Bisa Dibuktikan”.
