...
description: "Specify problem, users, scope/non-scope, requirements, evidence, integrations, data, security/privacy, accessibility, operations, acceptance, ownership, and response format"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Template Brief dan RFP Proyek Software”
- **Reader and situation:** Indonesian organization commissioning a digital product
- **Reader outcome:** Specify problem, users, scope/non-scope, requirements, evidence, integrations, data, security/privacy, accessibility, operations, acceptance, ownership, and response format
- **Primary intent:** Prepare a comparable request for proposal
...
- **Scope boundary:** Does not prescribe a solution or become Codev's quotation; `/kontak` owns actual enquiry and CDV-17-A02 owns estimate
- **Final public route:** `/artikel/template-brief-rfp-proyek-software.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Template Brief dan RFP Proyek Software**.
...
- **Tie back to this article:** Keep the explanation specific to “Template Brief dan RFP Proyek Software”.
