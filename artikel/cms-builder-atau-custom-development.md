...
description: "Compare editorial control, features, integrations, accessibility, performance, security, updates, ownership, and TCO"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “CMS, Website Builder, atau Custom Development”
- **Reader and situation:** SME comparing WordPress, hosted builder, and custom code
- **Reader outcome:** Compare editorial control, features, integrations, accessibility, performance, security, updates, ownership, and TCO
- **Primary intent:** Select a website implementation approach
...
- **Scope boundary:** Does not sell a WordPress package or choose a vendor; `/website-wordpress` owns commercial intent and CDV-17-A06 owns TCO
- **Final public route:** `/artikel/cms-builder-atau-custom-development.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **CMS, Website Builder, atau Custom Development**.
...
- `/website/custom` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/website/custom/` — use only if it helps the reader's next step; verify the anchor describes the destination.
...
- **Tie back to this article:** Keep the explanation specific to “CMS, Website Builder, atau Custom Development”.
