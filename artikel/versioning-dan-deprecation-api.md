...
- **Writer task:** Expand this file into one complete article answering: “Versioning dan Deprecation API Tanpa Memutus Klien”
- **Reader and situation:** API owner planning a breaking or behavioral change
- **Reader outcome:** Define compatibility, change classification, discovery, usage evidence, migration guide, overlap window, communication, and removal gate
- **Primary intent:** Evolve an API while protecting consumers
...
- **Scope boundary:** Does not promise a universal versioning scheme or timeline; actual consumer contracts govern
- **Final public route:** `/artikel/versioning-dan-deprecation-api.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Versioning dan Deprecation API Tanpa Memutus Klien**.
...
- `CDV-06-A03` → `/artikel/autentikasi-dan-otorisasi-api.html` — Autentikasi dan Otorisasi API Bukan Hal yang Sama
- `CDV-06-A05` → `/artikel/error-retry-dan-idempotency-api.html` — Error, Retry, dan Idempotency pada API
- `CDV-06-A06` → `/artikel/dokumentasi-dan-consumer-tests-api.html` — Dokumentasi dan Consumer Tests untuk API
...
- **Tie back to this article:** Keep the explanation specific to “Versioning dan Deprecation API Tanpa Memutus Klien”.
