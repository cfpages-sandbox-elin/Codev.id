...
description: "Define current baseline, task variability, error cost, data, volume, integration, human judgment, measurable benefit, pilot cap, and stop rule"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Memilih Use Case AI dan Automation dari Baseline”
- **Reader and situation:** Founder or operations owner considering automation
- **Reader outcome:** Define current baseline, task variability, error cost, data, volume, integration, human judgment, measurable benefit, pilot cap, and stop rule
- **Primary intent:** Decide whether AI, rules, workflow automation, or no change is justified
...
- **Scope boundary:** Does not sell an `automate.codev.id` workflow or assume AI is required; that subdomain owns its product catalog
- **Final public route:** `/artikel/memilih-use-case-ai-automation-baseline.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memilih Use Case AI dan Automation dari Baseline**.
...
- `CDV-16-A02` → `/artikel/human-in-the-loop-approval-banding.html` — Human-in-the-loop, Approval, dan Jalur Banding
...
- **Tie back to this article:** Keep the explanation specific to “Memilih Use Case AI dan Automation dari Baseline”.
