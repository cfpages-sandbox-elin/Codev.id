...
description: "Explain what each level proves, misses, costs, and how to combine them around stable contracts and critical journeys"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Unit, Integration, Contract, dan End-to-end Tests”
- **Reader and situation:** Developer or buyer reviewing automation coverage
- **Reader outcome:** Explain what each level proves, misses, costs, and how to combine them around stable contracts and critical journeys
- **Primary intent:** Choose test levels for different failure boundaries
...
- **Scope boundary:** Does not equate coverage percentage with confidence; CDV-10-A06 owns defect/exploratory feedback
- **Final public route:** `/artikel/unit-integration-contract-end-to-end.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Unit, Integration, Contract, dan End-to-end Tests**.
...
- **Tie back to this article:** Keep the explanation specific to “Unit, Integration, Contract, dan End-to-end Tests”.
