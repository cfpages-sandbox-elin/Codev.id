...
description: "Explain native semantics, focus order/visibility/management, keyboard behavior, escape/return, disabled states, and manual tests"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Keyboard, Focus, dan Komponen Interaktif”
- **Reader and situation:** Designer/developer building menus, dialogs, tabs, and controls
- **Reader outcome:** Explain native semantics, focus order/visibility/management, keyboard behavior, escape/return, disabled states, and manual tests
- **Primary intent:** Implement and test non-pointer interaction
...
- **Scope boundary:** Does not invent ARIA patterns or replace the WAI-ARIA Authoring Practices; component-specific current guidance governs
- **Final public route:** `/artikel/keyboard-focus-komponen-interaktif.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Keyboard, Focus, dan Komponen Interaktif**.
...
- `CDV-13-A01` → `/artikel/rencana-konformitas-wcag-22.html` — Menyusun Rencana Konformitas WCAG 2.2
...
- **Tie back to this article:** Keep the explanation specific to “Keyboard, Focus, dan Komponen Interaktif”.
