...
description: "Create an as-is journey showing actors, steps, data, delay, failure, workaround, and measurable baseline"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Memetakan Proses Saat Ini dan User Journey”
- **Reader and situation:** Product team replacing a manual or fragmented workflow
- **Reader outcome:** Create an as-is journey showing actors, steps, data, delay, failure, workaround, and measurable baseline
- **Primary intent:** Map present tasks, handoffs, pain points, and evidence
...
- **Scope boundary:** Does not design the future interface; CDV-02-A02 owns information architecture and flows
- **Final public route:** `/artikel/proses-saat-ini-dan-user-journey.html`
- **Appointed CMS date:** `2025-03-31` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Memetakan Proses Saat Ini dan User Journey**.
...
- `CDV-01-A02` → `/artikel/peta-pemangku-kepentingan-proyek-digital.html` — Peta Pemangku Kepentingan untuk Proyek Digital
...
- **Tie back to this article:** Keep the explanation specific to “Memetakan Proses Saat Ini dan User Journey”.
