...
description: "Define purpose, owner, status, evidence, due/review date, escalation, links, closure, and reporting for decisions, risks, assumptions, issues, and actions"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Decision Log, Risk Register, dan Issue Log yang Berbeda”
- **Reader and situation:** Delivery team losing context across chats and meetings
- **Reader outcome:** Define purpose, owner, status, evidence, due/review date, escalation, links, closure, and reporting for decisions, risks, assumptions, issues, and actions
- **Primary intent:** Keep project uncertainty and decisions traceable
...
- **Scope boundary:** Does not turn logs into bureaucracy or replace incident records; CDV-12-A05 owns incidents
- **Final public route:** `/artikel/decision-risk-issue-log.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Decision Log, Risk Register, dan Issue Log yang Berbeda**.
...
- **Tie back to this article:** Keep the explanation specific to “Decision Log, Risk Register, dan Issue Log yang Berbeda”.
