...
- **Writer task:** Expand this file into one complete article answering: “Information Architecture dan User Flow yang Bisa Diuji”
- **Reader and situation:** Designer planning navigation for a website or application
- **Reader outcome:** Produce a content inventory, hierarchy, labels, routes, states, and critical-task flow ready for testing
- **Primary intent:** Organize content and actions around user tasks
...
- **Scope boundary:** Does not own CMS taxonomy implementation; CDV-19-A01 owns content models
- **Final public route:** `/artikel/information-architecture-dan-user-flow.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Information Architecture dan User Flow yang Bisa Diuji**.
...
- **Tie back to this article:** Keep the explanation specific to “Information Architecture dan User Flow yang Bisa Diuji”.
