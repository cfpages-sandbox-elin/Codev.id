...
- **Writer task:** Expand this file into one complete article answering: “Data Model dari Istilah Bisnis ke Constraint”
- **Reader and situation:** Team before schema or integration design
- **Reader outcome:** Define terms, identifiers, entities, relationships, ownership, constraints, lifecycle states, audit needs, and unresolved ambiguity
- **Primary intent:** Turn domain language into consistent entities and rules
...
- **Scope boundary:** Does not select a database; CDV-07-A02 owns storage choice and product-specific schemas stay with their products
- **Final public route:** `/artikel/data-model-dari-istilah-bisnis.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Data Model dari Istilah Bisnis ke Constraint**.
...
- **Tie back to this article:** Keep the explanation specific to “Data Model dari Istilah Bisnis ke Constraint”.
