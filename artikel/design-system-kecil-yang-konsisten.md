...
- **Writer task:** Expand this file into one complete article answering: “Design System Kecil yang Tetap Konsisten”
- **Reader and situation:** Small team with inconsistent screens or duplicated components
- **Reader outcome:** Define tokens, components, states, content rules, accessibility notes, versioning, and ownership without overbuilding
- **Primary intent:** Decide what a maintainable design system needs
...
- **Scope boundary:** Does not choose a front-end framework; CDV-03-A03 owns stack choice and CDV-13 owns accessible component criteria
- **Final public route:** `/artikel/design-system-kecil-yang-konsisten.html`
- **Appointed CMS date:** `2025-05-01` (`editorial_backfill`; preserve exactly)
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Design System Kecil yang Tetap Konsisten**.
...
- **Tie back to this article:** Keep the explanation specific to “Design System Kecil yang Tetap Konsisten”.
