...
description: "Map purposes, categories, subjects, roles, grounds, notices, minimization, access, retention, vendors/transfers, rights, security, and deletion"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Privacy by Design untuk Produk Digital di Indonesia”
- **Reader and situation:** Indonesian product controller or processor at discovery/design
- **Reader outcome:** Map purposes, categories, subjects, roles, grounds, notices, minimization, access, retention, vendors/transfers, rights, security, and deletion
- **Primary intent:** Translate personal-data processing into design decisions
...
- **Scope boundary:** General education only; it does not determine lawful basis or compliance. UU PDP and current implementing rules require qualified Indonesian legal review
- **Final public route:** `/artikel/privacy-by-design-produk-digital-indonesia.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Privacy by Design untuk Produk Digital di Indonesia**.
...
- `CDV-09-A06` → `/artikel/vulnerability-intake-dan-security-incident.html` — Vulnerability Intake dan Security Incident Response
...
- **Tie back to this article:** Keep the explanation specific to “Privacy by Design untuk Produk Digital di Indonesia”.
