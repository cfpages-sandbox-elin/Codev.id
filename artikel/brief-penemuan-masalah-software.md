...
description: "Produce a one-page problem, user, current-state, constraint, evidence, and success brief"
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Brief Penemuan Masalah Sebelum Membuat Software”
- **Reader and situation:** Founder or product owner with an idea or broken process
- **Reader outcome:** Produce a one-page problem, user, current-state, constraint, evidence, and success brief
- **Primary intent:** Frame a software problem before proposing a solution
...
- **Scope boundary:** Does not select a stack or quote; CDV-03-A03 owns stack selection and CDV-17-A02 owns estimation
- **Final public route:** `/artikel/brief-penemuan-masalah-software.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Brief Penemuan Masalah Sebelum Membuat Software**.
...
- **Tie back to this article:** Keep the explanation specific to “Brief Penemuan Masalah Sebelum Membuat Software”.
