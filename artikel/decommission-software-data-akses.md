...
- **Writer task:** Expand this file into one complete article answering: “Decommission Software Tanpa Meninggalkan Data dan Akses”
- **Reader and situation:** Organization replacing or ending a digital product
- **Reader outcome:** Inventory users/data/integrations/domains/accounts, communicate, export, retain/delete, revoke, archive evidence, redirect, monitor, and close cost
- **Primary intent:** Retire a system safely and prove closure
...
- **Scope boundary:** Does not determine legal retention or destroy data without authority; CDV-07-A06 owns retention and CDV-18-A06 owns vendor exit
- **Final public route:** `/artikel/decommission-software-data-akses.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Decommission Software Tanpa Meninggalkan Data dan Akses**.
...
- **Tie back to this article:** Keep the explanation specific to “Decommission Software Tanpa Meninggalkan Data dan Akses”.
